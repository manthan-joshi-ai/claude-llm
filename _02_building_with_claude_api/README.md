...
| 10 | [10_simple_and_direct.md](10_simple_and_direct.md) | First prompt engineering technique: Simple + Direct — 5 moves (simple, explicit, first line, direct, action verbs), the solar-panel/geothermal examples verbatim from the course, and the real 2.32 → 3.92 score improvement it produced | 🟢 done |
