...
| 11 | [11_be_specific.md](11_be_specific.md) | Second technique: Be Specific — two guideline types (output-quality guidelines vs. process steps) and when to use each | 🟢 done |
