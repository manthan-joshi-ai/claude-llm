...
| 10 | [10_simple_and_direct.md](10_simple_and_direct.md) | First prompt engineering technique: Simple + Direct — 5 moves (simple, explicit, first line, direct, action verbs), the solar-panel/geothermal examples verbatim from the course, and the real 3.89 → 6.89 score improvement it produced | 🟢 done |
| 11 | [11_be_specific.md](11_be_specific.md) | Second technique: Be Specific — two guideline types (output-quality guidelines vs. process steps), when to use each, the meal-planning/story examples verbatim from the course, and the real 3.92 → 7.86 score improvement adding guidelines produced | 🟢 done |
