...
| 03 | [03_system_prompts.md](03_system_prompts.md) | The `system` parameter vs. `messages`; applies every turn; guardrails (soft, not hard-enforced) + defense layers; grounding vs. validating output (foreshadows RAG) | 🟢 done |
